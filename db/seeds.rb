...
RecruitmentInformation.destroy_all
...
15.times.each do |i|
  ...
  RecruitmentInformation.create title: "Recruitment infor #{i}", content: "content test", quantity: "20 employees (10 males, 10 female)",
